...
<calcite-modal aria-labelledby="modal-title" id="example-modal" scale='s'>
    ...
    <div id='modal-content' slot="content">
      <calcite-card>
        <img slot="thumbnail" alt="Sample image alt" src='/ea/client/images/EACommunities.png'>
      ...
      <calcite-card>
        <img slot="thumbnail" alt="Sample image alt" src='/ea/client/images/EAClimate.png'>
      ...
      <calcite-card>
        <img slot="thumbnail" alt="Sample image alt" src='/ea/client/images/EACompareMyArea.png'>
      ...
      <calcite-card>
        <img slot="thumbnail" alt="Sample image alt" src='/ea/client/images/EAHuc12Nav.png'>
      ...
      <calcite-card>
        <img slot="thumbnail" alt="Sample image alt" src='/ea/client/images/EARaindrop.png'>
      ...
      <calcite-card>
        <img slot="thumbnail" alt="Sample image alt" src='/ea/client/images/EASummMyArea.png'>
